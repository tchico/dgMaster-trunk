...
/**
 * Stage builder implementation: Creation of population entities and linkage
 * between entities
 * 
 * @author joaoesteves
 */
public class EntityStageBuilder extends AbstractBuilder {

	public EntityStageBuilder() {
		super("EntityStageBuilder", Logger.getLogger(EntityStageBuilder.class));
	}
