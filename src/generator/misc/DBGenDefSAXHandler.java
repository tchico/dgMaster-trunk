...
public class DBGenDefSAXHandler extends SAXDataHandler
{
    ...
    {
        utils = new Utils();
        vDBGenDef = new Vector<DBGeneratorDefinition>();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        if (qName.equalsIgnoreCase("database-scenario"))
        {
            ...
            vDBGenDef = new Vector<DBGeneratorDefinition>();
            vTableGenerators = new Vector<DBTableGenerator>();
        }
        ...
        {
            vDBForeignKeys = new ArrayList<DBForeignKey>();
        }
    ...
    public Vector<DBGeneratorDefinition> getData()
    {
