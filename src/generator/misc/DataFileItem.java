...
public class DataFileItem{
    ...
    public DataFileItem(DataFileItem clone)
    {
    	 randomiserInstanceName = clone.getRandomiserInstanceName() ;
    	 alignment=clone.getAlignment() ;
    	 encloseChar=clone.getEncloseChar();
    	 width=clone.getWidth();
    	 order=clone.getOrder();
    }
