   ...
   private int parsedElement=NONE; //used to retrieve the description element
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException
    {
        ...
        if(qName.equalsIgnoreCase("data-item"))
        {
            ...
            try
            {
                attribValue = attributes.getValue("order");
                dataItem.setOrder(Integer.parseInt(attribValue));
            }
            catch(Exception e)
            {
                logger.error("Error during integer conversion for order:"+attribValue);
                dataItem.setAlignment(Constants.ORDER_DEFAULT);
            }
