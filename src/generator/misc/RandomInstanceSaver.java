...
import generator.gui.RandomTypePanel;
...
public class RandomInstanceSaver
{
     ...
     * @param randomTypePanel 
     */
    public void saveData(Vector<RandomiserInstance> vData, RandomTypePanel randomTypePanel)
    {
        Element elemRI;
        ...
        File chosenFile = FileOutDataSaver.confirmReplacement(randomTypePanel, "Repository.xml");
