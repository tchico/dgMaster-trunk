...
public class DBWizardContainerPanel extends javax.swing.JPanel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 1788059209359252577L;
    ...
    public DBWizardContainerPanel()
    {
        ...
        alWizards = new ArrayList<IWizardStep>();
    ...
    private void saveDBDefinition()
    {
        try
        {
            ...
            Vector<DBFileDefinition> vDBD = ApplicationContext.getInstance().getDBD();
